...
tilenames = pd.read_csv('/home/dhayaa/Desktop/DECADE/Balrog_of_the_decade/runs/v08_ProductionRun3/Reproc_Astrofix_TilesToRedo_V2.txt', 
                        header = None)[0].values[args['TileStart']:args['TileEnd']]
